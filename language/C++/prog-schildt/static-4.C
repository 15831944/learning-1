...
int c1::ia_resursa()
{
	...
	{
		resursa=1;
		return 1;	//la resource c'est attribue a ce objet
	}
}
int main()
{
c1 ob1,ob2;
	if(c1::ia_resursa()) cout<<"ob1 a le droit d'accesse la resource\n";
	if(!c1::ia_resursa()) cout<<"ob2 n'a pas le droit d'accesse la resource\n";
