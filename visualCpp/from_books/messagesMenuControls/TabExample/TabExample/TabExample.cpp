...
BEGIN_MESSAGE_MAP(CTabExampleApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CTabExampleApp::OnAppAbout)
...
CTabExampleApp::CTabExampleApp() noexcept
{
	...
	SetAppID(_T("TabExample.AppID.NoVersion"));
...
BOOL CTabExampleApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CTabExampleDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CTabExampleView));
	if (!pDocTemplate)
		return FALSE;
...
int CTabExampleApp::ExitInstance()
{
...
// CTabExampleApp message handlers
...
void CTabExampleApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
