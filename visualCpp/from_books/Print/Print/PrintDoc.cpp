...
void CPrintDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CPrintDoc::InitializeSearchContent()
{
...
void CPrintDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
